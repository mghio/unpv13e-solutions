...
void sntp_proc(char *buf, ssize_t n, struct timeval *nowptr)
{
    ...
    printf("\nv%d, mode %d, start %d, ", version, mode, ntp->stratum);
    if (mode == MODE_CLIENT)
    {
        printf("client\n");
        return;
